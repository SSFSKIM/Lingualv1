...
- [ ] **Cost:** the `lingual` instance is `db-perf-optimized-N-8` (8 vCPU Enterprise Plus, ~$1-2K/mo) running idle while the skeleton is inert. Confirm intentional prod-sizing or right-size down until the first route cuts over.
