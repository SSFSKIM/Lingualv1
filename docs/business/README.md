...
| `22-vc-advisory-report.md` | External advisors (VC), founders | VC-facing advisory package: US + Korea B2B AI language learning market maps (growth, funding, positioning, relevance), pedagogy-engine abstract + rigorous research writeup, and the Zeta-mechanism engagement spec design. Written in Korean with English abstract. |
